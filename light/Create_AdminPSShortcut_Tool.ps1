# ============================================================
# Create_AdminPSShortcut Engine Loader V8 - Final Stable Version
# ============================================================
...
$DownloadURL = 'https://raw.githubusercontent.com/BlazeX86/Light-Help/main/light/Create_AdminPSShortcut.ps1'

# 3. Generate a temporary file path
$rand = Get-Random -Maximum 99999999
$isAdmin = [bool]([Security.Principal.WindowsIdentity]::GetCurrent().Groups -match 'S-1-5-32-544')
$FilePath = if ($isAdmin) { "$env:SystemRoot\Temp\Create_AdminPSShortcut_$rand.ps1" } else { "$env:TEMP\Create_AdminPSShortcut_$rand.ps1" }

Write-Host "[*] Launching Create_AdminPSShortcut Engine..." -ForegroundColor Cyan

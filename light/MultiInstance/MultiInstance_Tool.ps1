...
$DownloadURL = 'https://raw.githubusercontent.com/Cotton059/Light-Help/main/light/MultiInstance/MultiInstance.ps1'

$rand = Get-Random -Maximum 99999999

Write-Host "[*] Launching MultiInstance Engine..." -ForegroundColor Cyan
...
try {
    ...
    $ReportUrl = "run-count-reporter.q103495201.workers.dev" 
